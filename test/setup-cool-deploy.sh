...
if (git commit -m "Cool-Deploy Setup: Init Commit for Auto-Deployment [$TIMESTAMP]"); then
...
if git push; then
  echo
  echo -e "\033[33m✅ --- Successfully pushed Client & Server builds to GitHub. ---\033[0m"
else
  echo
  echo -e "\033[1;31m🛑 --- Failed to push Client & Server to GitHub!! ---\033[0m"
fi
